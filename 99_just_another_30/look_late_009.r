...
par(pty="s")
plotids <- with(look_late_012, plot3d(x, y, z, type="s", size = .2,
                                      xlim = c(0, 30), ylim = c(0, 30),zlim = c(0, 30000),
...
axesid <- decorate3d(xlim = c(0, 30), ylim = c(0, 30),zlim = c(0, 30000),
