...
# wxt
##set terminal wxt size 350,262 enhanced font 'Arial-Bold,10' persist
# png
#set terminal pngcairo size 350,262 enhanced font 'Arial-Bold',10'
#set output 'parametric3d.png'
# svg
#set terminal svg size 350,262 fname 'Arial-Bold ,Verdana, Helvetica, Arial, sans-serif' \
#fsize '12'
#set output 'parametric3d.svg'

# color definitions
set border lw 3
set style line 1 lc rgb '#00ad06' lt 1 lw 3   # --- green
set style line 2 lc rgb '#dd181f' lt 1 lw 3     # --- red
set style line 3 lc rgb '#949599' lt 2 lw 4    # --- grey
set style line 4 lc rgb '#0060ad' lt 1 lw 3    # --- blue
...
# Labels
set label 'u' at 0.25,0.13,0 textcolor ls 9
set label 'v' at 0.23,0.23,0.18 textcolor ls 9
set label 'r' at 0.6,0.6,1.1 textcolor ls 2
set label 'r cos(v)' at 0.5,0.4,0 rotate by 12 textcolor ls 8
...
set termoption font "Arial-Bold,14"
