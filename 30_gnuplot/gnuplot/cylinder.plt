...
set zrange [ -2.00000 : 2.00000 ] noreverse nowriteback
set cblabel "" 
...
f(u,v)=exp(u-0.2*v)
GNUTERM = "windows"
GPFUN_f = "f(u,v)=exp(u-0.2*v)"
splot cos(u),sin(u),v title "cylinder"
#splot cos(u),sin(u),v title "cylinder", 0.01*cos(u)*f(u,v),0.01*sin(u)*f(u,v),v title "function (scaled down)"
#    EOF
