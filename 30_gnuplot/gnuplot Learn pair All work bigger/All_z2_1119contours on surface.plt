...
set key title "" center
set title "All_z2_1119contours on surface.plt" noenhanced
set title  font "" norotate
set terminal windows title "All_z2_1119contours on surface.plt"
...
splot "snapinpairAll_z21119.txt" u 1:2:3 with lines
#    EOF
