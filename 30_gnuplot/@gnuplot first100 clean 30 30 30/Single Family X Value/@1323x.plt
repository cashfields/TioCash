...
#
set key title "" center
set title "@1323x.plt" noenhanced
set title  font "" norotate
set terminal windows title "@1323x.plt" enhanced background rgb 'white'
#
...
splot "work e 13x.txt" with points pointtype 7 pointsize 1 lc rgb "orange" , "work p 13x.txt" with points pointtype 7 pointsize 1 lc rgb "blue" , "work e 23x.txt" with points pointtype 7 pointsize 1 lc rgb "green" , "work p 23x.txt" with points pointtype 7 pointsize 1 lc rgb "red" , "work e 3 overlay.txt" with points pointtype 1 pointsize 2 lc rgb "black"
#    EOF
