...
#
set key title "" center
set title "@1929x.plt" noenhanced
set title  font "" norotate
set terminal windows title "@1929x.plt" enhanced background rgb 'white'
#
...
splot "work e 19x.txt" with points pointtype 7 pointsize 1 lc rgb "orange" , "work p 19x.txt" with points pointtype 7 pointsize 1 lc rgb "blue" , "work e 29x.txt" with points pointtype 7 pointsize 1 lc rgb "green" , "work p 29x.txt" with points pointtype 7 pointsize 1 lc rgb "red" , "work e 9 overlay.txt" with points pointtype 1 pointsize 2 lc rgb "black"
#    EOF
