...
set key title "" center
set title "All_z2_0723contours on surface.plt" noenhanced
set title  font "" norotate
set terminal windows title "All_z2_0723contours on surface.plt"
...
splot "snapinpairAll_z20723.txt" u 1:2:3 with lines
#    EOF
pause -1
