...
#set key title "" center
set title "All_z2_1119contours on surface extra data.plt" noenhanced
set title  font "" norotate
set terminal windows title "All_z2_1119contours on surface extra data.plt"
...
splot "snapinpairAll_z21119 extra data.txt" u 1:2:3 with lines
#    EOF
