...
#set key at screen 1, 0.9, 0 left top vertical Right noreverse enhanced autotitle box 3

#set key title "" center
set title "All_z2_0723contours on surface extra data.plt" noenhanced
set title  font "" norotate
set terminal windows title "All_z2_0723contours on surface extra data.plt"
...
splot "snapinpairAll_z20723 extra data.txt" u 1:2:3 with lines
#    EOF
